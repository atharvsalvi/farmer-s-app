...
class _CropDetailsScreenState extends State<CropDetailsScreen> {
  ...
  Future<void> _loadData() async {
    try {
      // Load Crop Data
      final String cropJson = await rootBundle.loadString(
        'backend/assets/crop_data.json',
      );
      ...
      final String fileName = widget.isSelling
          ? 'backend/assets/sell_market_data.json'
          : 'backend/assets/market_data.json';
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => PurchaseScreen(
                                ...
                                pricePerQt: (bestDeal['price'] as num)
                                    .toDouble(),
